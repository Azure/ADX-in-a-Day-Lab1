...
---
Earn a digital badge! In order to receive the "ADX-In-A-Day" digital badge, you will need to complete the tasks marked with 🎓. **Please submit the results of these tasks in the following link**: [Answer sheet - ADX Lab 1](https://forms.office.com/r/9GwkwHs9hv)
...
```
// execute the below commands one after another 
