# **Übung1: Erstellung von Clustern, Dateneingabe und Erkundung**

Dieses Übung ist in die folgenden 4 Herausforderungen unterteilt:
| Herausforderung | Beschreibung | Geschätzte Zeit |
|--|--|--|
| [Herausforderung 1](#challenge-1-create-an-adx-cluster)| Erstellen eines kostenlosen ADX-Clusters | 15 Min|
| [Herausforderung 2](#challenge-2-ingest-data-from-azure-storage-account)| Laden von Daten aus Azure Storage | 30 Min|
| [Herausforderung 3](#challenge-3-starting-with-the-basics-of-kql)| Mit den Grundlagen von KQL beginnen| 1 Stunde|
| [Herausforderung 4](#challenge-4-explore-and-transform-data)| Daten erforschen und umwandeln | 45 min|

Jede Herausforderung hat eine Reihe von Aufgaben, die erledigt werden müssen, um zur nächsten Herausforderung überzugehen. Es ist ratsam, die Herausforderungen und Aufgaben in der vorgeschriebenen Reihenfolge zu erledigen.

- [Zur ADX-In-A-Day-Startseite](https://github.com/Azure/ADX-in-a-Day)

**Erwerben Sie ein digitales Abzeichen!**

Um das digitale "ADX-In-A-Day"-Abzeichen zu erhalten, müssen Sie die mit ✅ gekennzeichneten Aufgaben in Labor 1 und Labor 2 lösen. Reichen Sie Ihre Antworten für die Quizfragen in Labor 1 und Labor 2 ein, um das digitale Abzeichen "ADX in a Day" zu erhalten. Sie können Ihre Antworten nachträglich bearbeiten oder es erneut versuchen.

| :information_source: **Note** |
|:---------------------------|
| **Für Übung 1 reichen Sie bitte die Ergebnisse für die mit ✅ gekennzeichneten Aufgaben unter folgendem Link ein**: [Quiz ADX in A Day Lab 1](https://forms.office.com/r/qZ0yghDwyb) |

| :information_source: **Note** |
|:---------------------------|
| **Bitte geben Sie uns 5 Arbeitstage Zeit für die Ausstellung des Abzeichens**|

![Screen capture 1](/assets/images/badge.png)

---

## **Herausforderung 1: Erstellen eines ADX-Clusters**

Um Azure Data Explorer (ADX) zu verwenden, müssen Sie zunächst einen kostenlosen ADX-Cluster erstellen und eine oder mehrere Datenbanken in diesem Cluster anlegen. Jede Datenbank hat Tabellen. Dann können Sie Daten in eine Datenbank einlesen, um Abfragen darauf auszuführen.

In dieser Challenge werden Sie einen kostenlosen Cluster und eine Datenbank erstellen. Sie werden einfache KQL-Abfragen im Kusto Web Explorer (KWE UI) ausführen.

**Aufgaben:**

- [**Aufgabe 1:** Erstellen eines ADX-Clusters und einer Datenbank](#challenge-1-task-1-create-an-adx-cluster-and-database)
- [**Aufgabe 2:** Überprüfen Sie die kostenlose Cluster-Homepage und die Azure Data Explorer Web UI](#challenge-1-task-2-review-the-free-cluster-home-page-and-the-azure-data-explorer-web-ui)
- [**Aufgabe 3:** Schreiben Sie Ihre erste Kusto Query Language (KQL) Abfrage](#challenge-1-task-3-write-your-first-kusto-query-language-kql-query)

**Erwartete Lernergebnisse:**

- Kostenlosen ADX-Cluster erstellen und damit arbeiten.

---

### **Herausforderung 1, Aufgabe 1: Erstellen Sie einen ADX-Cluster und eine Datenbank**

1. Erstellen Sie Ihren kostenlosen Cluster und Ihre Datenbank hier: [Kostenloser ADX-Cluster](https://aka.ms/kustofree). Wenn Sie die ADX Web UI in einem anderen Tab öffnen möchten, klicken Sie auf den Link und halten Sie die Taste ``STRG`` gedrückt.

    ![Bildschirmfoto 1](/assets/images/CreateNewCluster.png)
  
### **Herausforderung 1, Aufgabe 2: Schauen Sie sich die Homepage des freien Clusters und die Azure Data Explorer Web UI an**

1. Werfen Sie einen Blick auf die Cluster-Startseite.

2. Klicken Sie auf das Icon **Mein Cluster** im linken Navigationsbereich.

    ![Bildschirmfoto 1](/assets/images/free_cluster_create_db.png)

    Auf der Seite **Mein Cluster** sehen Sie Folgendes:
    - Den Namen Ihres Clusters, die Option zum Upgrade auf einen kostenpflichtigen Cluster und die Option zum Löschen des Clusters.
    - Cluster-Details wie: der Standort des Clusters und URI-Links für die Verbindung zu Ihrem Cluster über APIs oder andere Tools.
    - Schnelle Aktionen, die Sie durchführen können, um mit der Arbeit mit Ihrem Cluster anzufangen.
    - Eine Liste der Datenbanken in Ihrem Cluster.

3. Klicken Sie auf die Schaltfläche **Erstellen** in der Kachel **Datenbank erstellen**.

4. Geben Sie einen Namen für die Datenbank in das Feld **Datenbank** ein. Als Beispiel für den Namen können Sie ``FreeTestDB`` verwenden.

| :information_source: **Hinweis** |
|:---------------------------|
| Wenn Sie bereits einen kostenlosen Cluster haben und nur eine neue Datenbank für diese Übung erstellen möchten, verwenden Sie die Schaltfläche **Erstellen** in der Kachel **Datenbank erstellen.** |
  
### **Herausforderung 1, Aufgabe 3: Schreiben Sie Ihre erste Kusto Query Language (KQL)-Abfrage**
  
***Was ist eine Kusto-Abfrage?***

Azure Data Explorer bietet ein Web-Erlebnis, mit dem Sie sich mit Ihren Azure Data Explorer-Clustern verbinden und Kusto Query Language-Abfragen schreiben und ausführen können. Das Web-Erlebnis ist im Azure-Portal und als eigenständige Web-Anwendung verfügbar, die Azure Data Explorer Web UI, die wir später verwenden werden.

Eine *Kusto-Abfrage* ist eine schreibgeschützte Anfrage zur Verarbeitung von Daten und zur Rückgabe von Ergebnissen. Die Anfrage wird in einfachem, leicht zu lesendem Text formuliert. Eine Kusto-Abfrage hat eine oder mehrere Abfrageanweisungen und gibt Daten in einem Tabellen- oder Diagrammformat zurück.

In der nächsten Challenge werden wir Daten in den Cluster einspeisen, dann die wichtigsten Konzepte von KQL kennenlernen und interessante Abfragen schreiben. In dieser Aufgabe schreiben Sie eine grundlegende Abfrage, um ein Verständnis für die Umgebung zu bekommen.

In diesem Beispiel werden Sie die Webschnittstelle des Azure Data Explorer als Abfrage-Editor verwenden.

Die Kusto Query Language kann auch in anderen Diensten verwendet werden, die auf dem Azure Data Explorer aufbauen, wie z.B.:
